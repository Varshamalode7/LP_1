...
def main_screen():
	...
	code = StringVar()
	Entry(textvariable = code, width = 39, bd =0, font = ("arial", 12), show = "*").place(x = 10, y = 200)
	
	Button(text = "ENCRYPT", height = "2", width = 20, bg = "#ed3833", fg = "white", bd = 0, command = encrypt).place(x = 10, y = 250)
	Button(text = "DECRYPT", height = "2", width = 20, bg = "#00bd56", fg = "white", bd = 0, command = decrypt).place(x = 195, y = 250)
